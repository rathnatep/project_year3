      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this group? This action cannot be undone. All tasks and submissions will be permanently removed.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={leaveDialogOpen} onOpenChange={setLeaveDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to leave this group? You'll lose access to all tasks and your submissions will remain.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
      ...
      <Dialog open={!!deleteTaskId} onOpenChange={() => setDeleteTaskId(null)}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete this task? All submissions will also be removed.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
